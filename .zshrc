...
eval "$(/home/coder/.local/bin/oh-my-posh init zsh) --config 'https://raw.githubusercontent.com/JanDeDobbeleer/oh-my-posh/refs/heads/main/themes/catppuccin_latte.omp.json'"
#----------------------------------------------------------
# COMPLETION SETTINGS
